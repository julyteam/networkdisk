...
public class SendEmailUtil {
	...
	public static MimeMessage createSimpleMail(Session session ,String email,String code) throws Exception{
		...
		//设置发件人
		mm.setFrom(new InternetAddress("18552329592@163.com"));
		//设置收件人
		mm.setRecipient(Message.RecipientType.TO, new InternetAddress(email));
		 String MailBody="<p><img alt=\"westlakelogo\" src=\"http://mt1.baidu.com/timg?shitu&quality=100&sharpen=100&er=&imgtype=0&wh_rate=null&size=h120&sec=1506158359&di=b069c1b6064030bf6262630f97677234&src=http%3A%2F%2Fb.hiphotos.baidu.com%2Fimage%2F%2570%2569%2563%2Fitem%2F279759ee3d6d55fbdbdb823a66224f4a20a4dd89.jpg\" border=\"0\" /></p>"  
			        +"<p> 尊敬的用户<br />" +
			                ...
			                "<br />" +  
			                "<p>您的验证码为   <span style='color:red;font-size:30px'> " +code+ "</span>，有效期为180秒</p>" +  
	...
	public void sendEmail(String email,String code) throws Exception{
		...
		//3.通过邮件用户名密码链接
		ts.connect("18552329592@163.com", "july777");
	...
	public static void main(String[] args) throws Exception {
		...
		sendEmailUtil.sendEmail("610548834@qq.com", SendEmailUtil.createRandomVcode());
	}
}
